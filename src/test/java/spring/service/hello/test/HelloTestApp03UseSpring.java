...
public class HelloTestApp03UseSpring {
	...
	public static void main(String[] args) {
		...
		// BeanFactory 에서 주어진 경로에 있는 hello.xml 를 참고에서 Bean _ 주소에서 명시한 Class의 객체를 만들어달라 
		// Container를 이용해서  Hello 의 객체를 Container 에서 bean 으로 대신 만드는 것
		// BeanFactory 로 불러서 쓰면 그 자체가 Container. factory 가 BeanFactory를 구현하기 위한 객체 
		

		//2. Container 로 부터 hello 의 name 을 갖는  Hello 의 객체를 받기  instance return 받기  
		Hello hello = (Hello)factory.getBean("hello");   // 빈 설정문서의 내가 부여한 id 값과 동일해야 한다 
		hello.printMessage();
	}
